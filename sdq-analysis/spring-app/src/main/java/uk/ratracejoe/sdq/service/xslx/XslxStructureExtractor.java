package uk.ratracejoe.sdq.service.xslx;

import static uk.ratracejoe.sdq.service.xslx.XslxDemographicExtractor.DEMOGRAPHIC_SHEET_NAME;
...
public class XslxStructureExtractor {
  ...
  public Map<DemographicField, List<String>> extractDemographicOptions(Workbook workbook)
      throws SdqException {
  ...
  private List<String> getOptions(
      List<? extends DataValidation> validations, DemographicField field, Cell cell) {
